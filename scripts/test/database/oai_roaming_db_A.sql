-- Database initialization for PLMN A (MCC: 208, MNC: 22)
...
('208220000000031', '20822', '{"defaultSingleNssais": [{"sst": 1, "sd": "000001"}, {"sst": 222, "sd": "00007B"}]}'),
('208220000000032', '20822', '{"defaultSingleNssais": [{"sst": 1, "sd": "000001"}, {"sst": 222, "sd": "00007B"}]}');
...
CREATE TABLE `Amf3GppAccessRegistration` (
  ...
  `amfServiceNamePcscstRest` json DEFAULT NULL,
...
('208220000000031', '5G_AKA', '0C0A34601D4F07677303652C0462535B', '0C0A34601D4F07677303652C0462535B', '{"sqn": "000000000020", "sqnScheme": "NON_TIME_BASED", "lastIndexes": {"ausf": 0}}', '8000', 'milenage', '63bfa50ee6523365ff14c1f45f88737d', NULL, NULL, NULL, NULL, '208220000000031'),
('208220000000032', '5G_AKA', '0C0A34601D4F07677303652C0462535B', '0C0A34601D4F07677303652C0462535B', '{"sqn": "000000000020", "sqnScheme": "NON_TIME_BASED", "lastIndexes": {"ausf": 0}}', '8000', 'milenage', '63bfa50ee6523365ff14c1f45f88737d', NULL, NULL, NULL, NULL, '208220000000032');
...
('208220000000031', '20822', '{"sst": 222, "sd": "00007B"}', '{"default":{"pduSessionTypes":{"defaultSessionType":"IPV4"},"sscModes":{"defaultSscMode":"SSC_MODE_1"},"5gQosProfile":{"5qi":6,"arp":{"priorityLevel":1,"preemptCap":"NOT_PREEMPT","preemptVuln":"NOT_PREEMPTABLE"},"priorityLevel":1},"sessionAmbr":{"uplink":"100Mbps","downlink":"100Mbps"},"staticIpAddress":[{"ipv4Addr":"12.1.1.4"}]}}'),
('208220000000032', '20822', '{"sst": 1, "sd": "000001"}', '{"oai.ipv4":{"pduSessionTypes":{"defaultSessionType":"IPV4"},"sscModes":{"defaultSscMode":"SSC_MODE_1"},"5gQosProfile":{"5qi":9,"arp":{"priorityLevel":1,"preemptCap":"NOT_PREEMPT","preemptVuln":"NOT_PREEMPTABLE"},"priorityLevel":1},"sessionAmbr":{"uplink":"100Mbps","downlink":"200Mbps"}}}');
...
-- Indexes
--
ALTER TABLE `AccessAndMobilitySubscriptionData` ADD PRIMARY KEY (`ueid`,`servingPlmnid`) USING BTREE;
ALTER TABLE `Amf3GppAccessRegistration` ADD PRIMARY KEY (`ueid`);
ALTER TABLE `AuthenticationStatus` ADD PRIMARY KEY (`ueid`);
ALTER TABLE `AuthenticationSubscription` ADD PRIMARY KEY (`ueid`);
ALTER TABLE `SdmSubscriptions` ADD PRIMARY KEY (`subsId`,`ueid`) USING BTREE;
ALTER TABLE `SessionManagementSubscriptionData` ADD PRIMARY KEY (`ueid`,`servingPlmnid`) USING BTREE;
ALTER TABLE `SmfRegistrations` ADD PRIMARY KEY (`ueid`,`subpduSessionId`) USING BTREE;
ALTER TABLE `SmfSelectionSubscriptionData` ADD PRIMARY KEY (`ueid`,`servingPlmnid`) USING BTREE;

ALTER TABLE `SdmSubscriptions` MODIFY `subsId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
